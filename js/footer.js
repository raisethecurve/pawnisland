...
class ChessFooter {
    ...
    updateFooterForTheme() {
        ...
        // The footer already uses the dark chess theme.
    }

    /**
     * Keep the copyright year current after loading the partial.
     */
    updateCopyrightYear() {
        const year = this.footer.querySelector('#current-year');
        if (year) {
